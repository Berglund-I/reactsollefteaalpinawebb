        ...
        <div className="App">
            <section className="competition-page">
                ...
                <article className="competition-home">
                    ...
                    <p className="competition-home-text">Här kan du se tävlingar som vi i Sollefteå alpina klubb är med
                        och arrangera</p>
                ...
                <article className="competition-calender">
                    ...
                    <a href="https://ta.skidor.com/EventCalendar.aspx?orgid=80"
                       className="button-to-competitionCalendar">Klicka här för att gå till Tävlingskalendern <i className="bi bi-box-arrow-up-right"></i> </a>
                </article>
