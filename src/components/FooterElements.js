...
function FooterElements(){
    return (
        <Box sx={{
            ...
            <Grid container spacing={3} sx={{flexWrap: 'nowrap', justifyContent: 'space-between'}}>

                <Grid item xs={12} sm={4} >
                    <Box sx={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: 3, paddingTop: '30px' }}>
                        <Box sx={{ pl: 3 }}>
                ...
                <Grid item xs={12} sm={4} >
                <Grid container alignItems="center" justifyContent="center" padding="30px">
                ...
                <Grid item xs={12} sm={4}>
                    <Box sx={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: 3, paddingTop: '30px', justifyContent: 'flex-end' }}>
                        <Box>
